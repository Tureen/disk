...
<script type="text/javascript" src="${staticpath}/js/contact/index.js?v=20170221"></script>
        ...
        <div class="main_con main_con_an"> 
            <div class="r_topcon r_topcon_an">
                <div class="actionbox cf">
                        <div class="crumbs"><ul><li><i class="tip_t3"></i><a href="javascript:void(0);"><fmt:message key="contact_my" bundle="${i18n}" /></a></li></ul></div>
                        <div class="action_btn">
                            <ul>
                                <li class="ac_del"><i class="ac_t08"></i><fmt:message key="c_delete_contact" bundle="${i18n}" /></li>
                            </ul>
                        </div>
                        <div class="r_search_contain">
                         <form action="${ctx}/contact/index" method="post" id="searchForm">
            ...
            <form action="${ctx }/contact/index" id = "queryForm" method="post">
	            ...
	            <div id="mainContent">
	                <div class="tab_contain" style="height: 100%">
	                    ...
	                    <table class="tabs" id="tabs">
	                    	<c:forEach items="${query.list}" var="contact">
	                    		<tr class="stabs">
	                    			<td width="10%">
		                            	<i class="tab_check" name="msgItem" value="${contact.employee.id}"></i>
		                            </td>
		                            <td width="20%">
		                            	${contact.employee.employeeName }
	                            	</td>
		                            <td width="20%">
		                            	${contact.employee.employeeMobile }
	                            	</td>
		                            <td width="30%">
		                            	${contact.employee.employeeEmail }
	                            	</td>
		                            <td width="20%">
		                            	${contact.employee.deptName }
	                            	</td>
	                    		</tr>
	                    	</c:forEach>
	                    </table> 
