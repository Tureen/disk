...
<script type="text/javascript" src="${staticpath}/js/share/index.js?v=20170213"></script>
            ...
            <div class="r_topcon r_topcon_an">
                <div class="actionbox cf">
                        ...
                        <ul>
			                ...
			                <li><a href="${ctx}/share/index"><fmt:message key="share_space" bundle="${i18n}"/></a></li>
	            ...
	            <div id="mainContent" <c:if test="${fn:length(folder.folders) + fn:length(folder.files) > 0}">style="display: block"</c:if>
	                ...
	                <table class="tabs_th">
	                    <tr>
                            ...
                            <th width="10%">&nbsp;</th>
                            <th width="10%"><fmt:message key="creater" bundle="${i18n}"/></th>
