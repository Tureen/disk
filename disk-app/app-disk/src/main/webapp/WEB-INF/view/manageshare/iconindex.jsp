...
<script type="text/javascript" src="${staticpath}/js/manageshare/icon.js?v=20170103"></script>
            ...
            <div class="r_topcon r_topcon_an">
                <div class="actionbox cf">
                        <div class="crumbs">
			                ...
			                <li><a href="${ctx}/manageshare/index" style="max-width: 140px"><fmt:message key="management_public_space" bundle="${i18n}"/></a></li>
                   ...
                   <div class="array_list">
                       <ul>
                           ...
                           <li>
                               ...
                               <p class="txt_name"><a href="${pageContext.request.contextPath }/manageshare/index?folderId=${fo.id}" >${fo.folderName }</a></p>
