...
<script type="text/javascript" src="${staticpath}/js/bshare/index.js"></script>
        ...
        <div class="main_con">
        	<div class="r_topcon">
        		<div class="actionbox cf">
        			...
        			<ul>
        				...
        				<li><a href="${ctx}/bshare/index"><fmt:message key="shared_space" bundle="${i18n}"/></a></li>
        				<c:forEach items="${folders}" var="folder">
			            	<li><a class="cutword" title="${folder.folderName }" href="${ctx}/bshare/indexinto/${upId }/${folder.id}/${folder.employeeId}">&nbsp;&gt;&nbsp;${folder.folderName }</a></li>
			            </c:forEach>
            ...
            <div class="content">
	            ...
	            <div id="mainContent" <c:if test="${fn:length(folder.folders) + fn:length(folder.files) > 0}">style="display: block"</c:if>
						...
						<table id="new_tr" style="display:none">
	                        <tr>
	                            ...
	                            <input type="hidden" id="upId" value="${upId}" />
                   				<input type="hidden" id="employeeId" value="${folder.employeeId}" />
					...
					<input type="hidden" name="auth" value="${operAuth }"/>
					</i></td>
		                        <td width="30%">
		                        	<p class="filebox">
		                        		<i class="tipbg tips_bg_files"></i>
		                        		<span class="file_name">
		                        			<a class="remove_check" id="tofo${fo.id }" href="${ctx }/bshare/indexinto/${upId }/${fo.id }/${fo.employeeId}">${fo.folderName }</a>
		                        		</span>
					...
					<input type="hidden" name="auth" value="${operAuth }"/></i></td>
		                        <td width="30%">
		                        	<p class="filebox">
