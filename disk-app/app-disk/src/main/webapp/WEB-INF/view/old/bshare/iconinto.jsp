...
<script type="text/javascript" src="${staticpath}/js/bshare/icon.js?v=20160811"></script>
            ...
            <div class="r_topcon">
                <div class="actionbox cf">
                        <div class="crumbs">
			                ...
			                <li><a href="${ctx}/bshare/index">他人共享</a></li>
                   ...
                   <div class="array_list">
                       <ul>
                           ...
                           <li>
                               ...
                               <p class="txt_name"><a href="${ctx }/bshare/indexinto/${upId}/${fo.id }/${fo.employeeId}" id="tofo${fo.id }">${fo.folderName }</a></p>
