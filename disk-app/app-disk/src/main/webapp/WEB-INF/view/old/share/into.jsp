...
<script type="text/javascript" src="${staticpath}/js/share/index.js?v=20160901"></script>
            ...
            <div class="r_topcon">
                <div class="actionbox cf">
                        ...
                        <ul>
			                ...
			                <li><a href="${ctx}/share/index">我的共享</a></li>
				            <c:forEach items="${folders}" var="folder">
				            	<li><a  class="cutword" title="${folder.folderName }" href="${ctx}/share/indexinto/${folder.id}">&nbsp;&gt;&nbsp;${folder.folderName }</a></li>
				            </c:forEach>
                        ...
                        <div class="action_btn">
                            <ul>
                                <li class="ac_folder"><i class="ac_t01"></i>新建文件夹</li>
                                <li class="ac_refresh"><i class="ac_t03"></i>刷新</li>
                                <li class="ac_upload"><i class="ac_t02"></i>上传<i class="ac_down_box"></i>
