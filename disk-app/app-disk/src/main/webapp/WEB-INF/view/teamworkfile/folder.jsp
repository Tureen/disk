...
<input id="teamworkName" type="hidden" value="${teamworkName }">
<div id="con_move">
    ...
    <SCRIPT type="text/javascript">
        ...
        var zNodes =[
                 { id:0, pId:0, code:"", name:$("#teamworkName").val(), open:true, isParent:true, "icon": basepath+"/static/images/tip_files.png"},
        ];
		...
		var setting = {
			...
			async: {
				enable: true,
				url:basepath +　"/teamworkfile/jsonFolderTree?teamworkId=" + $("#teamworkId").val(),
				autoParam: ["id"],
				dataFilter: filter
			},
			callback: {
		...
		function refreshNode(e) {
			...
			if (nodes.length == 0) {
				layer.msg(i18n_please_select_a_parent_node,{icon: 5,time:1000});
			}
