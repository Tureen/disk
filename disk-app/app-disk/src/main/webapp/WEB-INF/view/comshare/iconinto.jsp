...
<script type="text/javascript" src="${staticpath}/js/comshare/icon.js?v=20170103"></script>
                   ...
                   <div class="array_list">
                       <ul>
                           ...
                           <li>
                               ...
                               <p class="txt_name"><a href="${ctx }/comshare/indexinto/${upId}/${fo.id }/${fo.employeeId}" id="tofo${fo.id }">${fo.folderName }</a></p>
