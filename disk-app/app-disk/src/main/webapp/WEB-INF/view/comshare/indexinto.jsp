...
<script type="text/javascript" src="${staticpath}/js/comshare/index.js?v=20170103"></script>
        	...
        	<div class="r_topcon r_topcon_an">
        		<div class="actionbox cf">
        			<div class="crumbs">
        				...
        				<li><a href="${ctx}/comshare/index"><fmt:message key="public_space" bundle="${i18n}"/></a></li>
        				<c:forEach items="${folders}" var="folder">
			            	<li><a class="cutword" title="${folder.folderName }" href="${ctx}/comshare/indexinto/${upId }/${folder.id}/${folder.employeeId}">&nbsp;&gt;&nbsp;${folder.folderName }</a></li>
			            </c:forEach>
		                        ...
		                        <td width="30%">
		                        	<p class="filebox">
		                        		...
		                        		<span class="file_name">
		                        			<a class="remove_check" id="tofo${fo.id }" href="${ctx }/comshare/indexinto/${upId }/${fo.id }/${fo.employeeId}">${fo.folderName }</a>
		                        		</span>
