...
<div class="page-container">
  <form action="${ctx }/basicsinfo/save" method="post"  id="queryForm" class="form form-horizontal">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>属性键：</label>
