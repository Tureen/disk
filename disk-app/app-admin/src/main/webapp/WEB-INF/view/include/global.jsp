...
<link rel="stylesheet" type="text/css" href="${plugins}/static/h-ui/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="${plugins}/lib/Hui-iconfont/1.0.7/iconfont.css" />
<link rel="stylesheet" type="text/css" href="${plugins}/lib/icheck/icheck.css" />
<link rel="stylesheet" type="text/css" href="${plugins}/static/h-ui/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="${plugins}/static/h-ui/css/style.css" />
...
<script type="text/javascript" src="${plugins}/static/h-ui/js/H-ui.admin.js?v=20161109"></script> 
