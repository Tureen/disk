...
<script type="text/javascript" src="${staticpath }/js/dept/saveoredit.js"></script>
<style type="text/css">
.menuContent{
    height:100px;
    width:428px;
...
$(document).ready(function(){
	$("#queryForm").validate({
		...
		submitHandler:function(form){
		    ...
		    var _url = basepath + '/dept/editDept';
			$.ajax({
				url :  _url,
				dataType : "JSON",
  ...
  <form method="post"  id="queryForm" class="form form-horizontal">
    <div class="row cl">
      ...
      <input type="hidden" name="id" value="${department.id }" id="id">
        <input type="text" class="input-text" placeholder=""  name="deptName" value="${department.deptName }" id="deptName">
      </div>
      <div class="col-5"> </div>
    </div>
    <div class="row cl">
