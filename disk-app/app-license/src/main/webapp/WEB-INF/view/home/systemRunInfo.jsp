...
.tableBorder {BORDER-RIGHT: #183789 1px solid; BORDER-TOP: #183789 1px solid; BORDER-LEFT: #183789 1px solid; BORDER-BOTTOM: #183789 1px solid; BACKGROUND-COLOR: #ffffff; WIDTH: 98%;}
.divcenter {
	position:absolute;
	height:30px;
	z-index:1000;
...
<CENTER>
  <STRONG style="FONT-SIZE: 20pt">系统运行环境</STRONG> <br/>
