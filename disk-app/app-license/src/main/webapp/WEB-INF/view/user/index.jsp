...
<script type="text/javascript" src="${staticpath }/js/user/index.js?v=20160627"></script>
		...
		<tbody>
		    <c:forEach items="${query.list}" var="emp" >
		     <tr class="text-c">
				...
				<a title="编辑" href="javascript:;" onclick="admin_admin_edit('角色编辑','${ctx}/admin/toupdate/${adminType[0].type }/${emp.id}','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
