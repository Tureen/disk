...
<body>
<div class="layui-layer-title"><fmt:message key="i18n_upload_files" bundle="${i18n}" /></div>
...
var diskServerUrl = '${diskServerUrl}';
var webname = '${webname}';
...
$(function(){
	...
	uploader.on( 'uploadSuccess', function( file, response) {
		userInfo.zFileId = response.id;
		userInfo.realUploadType = response.uploadType;
		userInfo.teamworkMessageId = response.teamworkMessageId;
		//设置提示内容
