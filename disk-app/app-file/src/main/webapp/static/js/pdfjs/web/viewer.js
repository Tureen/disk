...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = basepath + '/static/js/pdfjs/web/images/';
  PDFJS.workerSrc = basepath + '/static/js/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = basepath + '/static/js/pdfjs/web/cmaps/';
