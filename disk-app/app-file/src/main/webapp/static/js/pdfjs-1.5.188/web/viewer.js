...
function configure(PDFJS) {
	PDFJS.imageResourcesPath = basepath + '/static/js/pdfjs-1.5.188/web/images/';
	PDFJS.workerSrc = basepath + '/static/js/pdfjs-1.5.188/build/pdf.worker.js';
	PDFJS.cMapUrl = basepath + '/static/js/pdfjs-1.5.188/web/cmaps/';
...
function webViewerInitialized() {
  ...
  if(document.getElementById('openFile') != undefined){
...
window.addEventListener('updateviewarea', function (evt) {
  ...
  if(document.getElementById('viewBookmark') != undefined){
	  var href =
