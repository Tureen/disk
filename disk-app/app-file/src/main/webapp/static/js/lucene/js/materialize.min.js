        ...
        t(document).ready(function() {
            ...
            t(this).each(function() {
                if ($select = t(this), !$select.hasClass("browser-default")) {
                    ...
                    var a = t('<ul id="select-options-' + n + '" class="dropdown-content select-dropdown"></ul>'),
                    ...
                    var l = t('<i class="mdi mdi-menu-down"></i>');
                    ...
                    $select.before(u), u.before(l), t("body").append(a), $select.is(":disabled") || u.dropdown({
                        hover: !1
...
Vel = $ ? $.Velocity : Velocity, ! function(t, e, i, n) {
        ...
        var le = ["", "webkit", "moz", "MS", "ms", "o"],
            ...
            ye = x(t, "PointerEvent") !== n,
            me = ge && ve.test(navigator.userAgent),
            be = "touch",
            we = "pen",
            xe = "mouse",
            ke = "kinect",
        ...
        t.MSPointerEvent && (Ne = "MSPointerDown", Re = "MSPointerMove MSPointerUp MSPointerCancel"), u(z, C, {
            handler: function(t) {
                var e = this.store,
                    ...
                    o = Qe[n],
                    a = We[t.pointerType] || t.pointerType,
                    r = a == be,
        ...
        X.prototype = {
            ...
            process: function(t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Te | Oe) && !a) this.reset();
                else if (t.eventType & Ce) this.reset(), this._timer = o(function() {
            ...
            return this.each(function() {
                function e() {
                    ...
                    var e = r.parent(".material-placeholder"),
                        o = (window.innerWidth, window.innerHeight, r.data("width")),
                        s = r.data("height");
    ...
    function(t) {
        ...
        function i() {
            ...
            var i = a.scrollTop(),
                ...
                o = n + a.width(),
                r = i + a.height(),
                l = e(i + c.top + 200, o + c.right, r + c.bottom, n + c.left);
        ...
        t.scrollSpy = function(e, n) {
            ...
            return t.winSizeSpy = function() {
                ...
                throttle: 100
            }, a.on("resize", o(n, e.throttle || 100))
        ...
        var e = {
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    function i(i) {
                        a = !1, r = !1, t("#sidenav-overlay").velocity({
                            opacity: 0
                        }, {
                            duration: 200,
                            queue: !1,
                    ...
                    240 != e.menuWidth && o.css("width", e.menuWidth), t("body").append(t('<div class="drag-target"></div>')), "left" == e.edge ? (o.css("left", -1 * (e.menuWidth + 10)), t(".drag-target").css({
                        left: 0
                    })) : (o.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""), t(".drag-target").css({
                        right: 0
                    })), o.hasClass("fixed") && t(window).width() > 992 && o.css("left", 0), o.hasClass("fixed") && t(window).resize(function() {
                    ...
                    t(".drag-target").on("click", function() {
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            a = !1, "left" === e.edge ? r && .3 >= n || -.5 > n ? (o.velocity({
                                left: 0
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function(t) {
        t.fn.slider = function(e) {
            ...
            return e = t.extend(i, e), this.each(function() {
                ...
                function n(t) {
                    t >= s.length ? t = 0 : 0 > t && (t = s.length - 1), l = r.find(".active").index(), l != t && (o = s.eq(l), $caption = o.find(".caption"), o.removeClass("active"), o.velocity({
                        opacity: 0
                    }, {
                ...
                o ? o.show() : (s.first().addClass("active").velocity({
                    opacity: 1
                }, {
                    duration: e.transition,
                    queue: !1,
                ...
                a.hammer({
                    ...
                    if ("touch" === t.gesture.pointerType) {
                        ...
                        var o;
                        d && (o = $curr_slide.next(), 0 === o.length && (o = s.first()), o.velocity({
                            opacity: 1
                        }, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
                        })), p && (o = $curr_slide.prev(), 0 === o.length && (o = s.last()), o.velocity({
                            opacity: 1
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function(t) {
        ...
        function o(t) {
            ...
            if (e.classList.add("toast"), i)
                for (var o = i.split(" "), a = 0, r = o.length; r > a; a++) e.classList.add(o[a]);
            e.innerHTML = t;
            var s = new Hammer(e, {
                prevent_default: !1
            });
            return s.on("pan", function(t) {
                ...
                }) : (e.classList.remove("panning"), $.Velocity(e, {
                    left: 0,
                    opacity: 1
                }, {
                    duration: 300,
        ...
        var r = o(t);
        a.appendChild(r), r.style.top = "35px", r.style.opacity = 0, $.Velocity(r, {
            top: "0px",
            opacity: 1
        }, {
            duration: 300,
    ...
    function(t) {
        t.fn.tooltip = function(e) {
            ...
            return e = t.extend(r, e), t(".material-tooltip").remove(), this.each(function() {
                var r = t(this),
                    s = t("<span></span>").text(r.attr("data-tooltip")),
                    l = t("<div></div>");
                ...
                u.appendTo(l), u.css({
                        ...
                        s = void 0 == s || "" == s ? e.delay : s, i = 0, o = setInterval(function() {
                            if (i += 10, i >= s && 0 == n) {
                                ...
                                "top" === o ? (l.css({
                                    ...
                                    marginLeft: d / 2 - u.width() / 2
                                })), f = d / 8, 8 > f && (f = 8), ("right" === o || "left" === o) && (f = d / 10, 6 > f && (f = 6)), l.velocity({
                                    opacity: 1,
                                    marginTop: p,
                                    marginLeft: h
                                }, {
                    ...
                    mouseleave: function() {
                        clearInterval(o), i = 0, l.velocity({
                            opacity: 0,
                            marginTop: 0,
                            marginLeft: 0
                        }, {
            ...
            i.isWindow = function(t) {
                ...
                for ("boolean" == typeof s && (c = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++)
                    if (null != (a = arguments[l]))
                        for (o in a) t = s[o], n = a[o], s !== n && (c && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, r = t && i.isArray(t) ? t : []) : r = t && i.isPlainObject(t) ? t : {}, s[o] = i.extend(c, r, n)) : void 0 !== n && (s[o] = n));
                return s
        ...
        return function(t, e, i, n) {
            ...
            var k = function() {
                            ...
                            for (var I in g) {
                                ...
                                if (r(a).isSVG || "tween" === F || x.Names.prefixCheck(F)[1] !== !1 || x.Normalizations.registered[F] !== n) {
                                    ...
                                    if (W = d(I, z), z = W[0], R = W[1], W = d(I, j), j = W[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return H = e, ""
                                        }), N = W[1], z = parseFloat(z) || 0, j = parseFloat(j) || 0, "%" === N && (/^(fontSize|lineHeight)$/.test(I) ? (j /= 100, N = "em") : /^scale/.test(I) ? (j /= 100, N = "") : /(Red|Green|Blue)$/i.test(I) && (j = j / 100 * 255, N = "")), /[\/*]/.test(H)) N = R;
                                    else if (R !== N && 0 !== z)
                                        if (0 === j) N = R;
                                        else {
                                            o = o || h();
                ...
                if (v.isWrapped(this) ? (s = !1, h = 0, f = this, l = this) : (s = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                    ...
                    if (E.loop = parseInt(E.loop), _ = 2 * E.loop - 1, E.loop)
                        for (var j = 0; _ > j; j++) {
                            var L = {
                                delay: E.delay,
                                progress: E.progress
            ...
            function f() {
                C.$root.on({
                    ...
                    var e = t(this),
                        ...
                        o = s();
                    o = o && (o.type || o.href), (n || o && !t.contains(C.$root[0], o)) && C.$root[0].focus(), !n && i.nav ? C.set("highlight", C.component.item.highlight, {
                        nav: i.nav
    ...
    function(t) {
        ...
        i.prototype.set = function(t, e, i) {
            ...
            if ((!n || !n.nav) && (!p && u.disabled(i) || p && u.disabled(i) && (v || o || r) || !p && (i.pick <= h.pick || i.pick >= f.pick)))
                for (p && !v && (!r && d > 0 || !o && 0 > d) && (d *= -1); u.disabled(i) && (Math.abs(d) > 1 && (i.month < c.month || i.month > c.month) && (i = c, d = d > 0 ? 1 : -1), i.pick <= h.pick ? (s = !0, d = 1, i = u.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, d = -1, i = u.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !s || !l);) i = u.create([i.year, i.month, i.date + d]);
            return i
            ...
            return e && "string" == typeof e ? (i && i.format || (i = i || {}, i.format = n.settings.format), n.formats.toArray(i.format).map(function(t) {
                var i = n.formats[t],
                    r = i ? a.trigger(i, n, [e, o]) : t.replace(/^!/, "").length;
            ...
            var e = this,
                ...
                g = function(n) {
                    ...
                    }), i.klass.selectMonth + " browser-default", (t ? "" : "disabled") + " " + a.ariaAttr({
                        controls: e.$node[0].id + "_table"
                    }) + ' title="' + i.labelMonthSelect + '"') : "short_months" == n ? null != l ? a.node("div", o[l.month]) : a.node("div", o[c.month]) : a.node("div", o[c.month], i.klass.month)
                },
                y = function(n) {
                    var o = c.year,
                    ...
                    if (r) {
                        ...
                        }), i.klass.selectYear + " browser-default", (t ? "" : "disabled") + " " + a.ariaAttr({
                            controls: e.$node[0].id + "_table"
            ...
            return createDayLabel = function() {
                ...
                readonly: !0
            })), i.klass.calendar_container) + a.node("div", a.node("button", i.today, "btn-flat picker__today", "type=button data-pick=" + s.pick + (t && !e.disabled(s) ? "" : " disabled") + " " + a.ariaAttr({
                controls: e.$node[0].id
            })) + a.node("button", i.clear, "btn-flat picker__clear", "type=button data-clear=1" + (t ? "" : " disabled") + " " + a.ariaAttr({
                controls: e.$node[0].id
            })) + a.node("button", i.close, "btn-flat picker__close", "type=button data-close=true " + (t ? "" : " disabled") + " " + a.ariaAttr({
                controls: e.$node[0].id
            })), i.klass.footer)
