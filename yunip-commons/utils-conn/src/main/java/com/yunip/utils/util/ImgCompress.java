...
public class ImgCompress {
     ...
     * 构造函数
     */
    public ImgCompress(String fileName ,String lastFileName) throws IOException {
    ...
    public void resize(int w, int h) throws IOException {
        ...
        File destFile = new File(lastFileName);
        String formatName = lastFileName.substring(lastFileName.lastIndexOf(".") + 1);
