...
public class Page<T> {
    ...
    /**查询用户文档索引的地址(c:/file/index/employeeId)**/
    private String         queryIndexDir;
    
    /**查询用户文档索引的多目录地址集合(c:/file/index/employeeId)**/
    private Set<String> queryMulIndexDir;
    ...
    public String getQueryIndexDir() {
        return queryIndexDir;
    }

    public void setQueryIndexDir(String queryIndexDir) {
        this.queryIndexDir = queryIndexDir;
    }
    ...
    public Page(int currentPage, int pageSize, T items) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
    }

    public Page(int currentPage, int pageSize, T items, int groupSize) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
        this.groupSize = groupSize;
    ...
    public Set<String> getQueryMulIndexDir() {
        return queryMulIndexDir;
    }

    public void setQueryMulIndexDir(Set<String> queryMulIndexDir) {
        this.queryMulIndexDir = queryMulIndexDir;
    }
