...
/**
 * MD5加密工具类，支持密钥加密
 * 修改说明：添加方法，用于指定MD5数据的编码编码格式，比如指定'UTF-8'
 * 修改人:pan.tang
 * 修改时间:2013-4-23
 */
public class Md5 {
	 ...
	 * @exception
	 */
	public static String encodeByMd5(String s , String encoding) throws Exception {
...
public static void main(String[] args) throws Exception{
    /*String pwd=	Md5.encodeByMd5("www761!@#");
	System.out.println(pwd);*/
	String s=DigestUtils.md5Hex(new FileInputStream(new File("C:\\Users\\yinpeng\\Desktop\\tomcat\\apache-tomcat-7.0.77_32\\webapps\\disk\\WEB-INF\\classes\\com\\yunip\\web\\common\\CheckLoginFilter.class")));
