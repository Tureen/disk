...
public class ZipUtil {
     ...
     * @throws Exception
     */
    public static String decompress(String zipFile) throws Exception {
    ...
    public static String decompress(File srcFile) throws Exception {
        //创建当前文件夹
        String fileName = srcFile.getPath().substring(0,
                srcFile.getPath().lastIndexOf("."));
        decompress(srcFile, fileName);
        return fileName;
    }
    ...
    public static void main(String[] args) throws Exception {
        File srcFile = new File("C:\\Users\\Administrator\\Desktop\\ggg.zip");
        decompress(srcFile);
    }
}
